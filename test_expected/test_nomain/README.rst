...
using `python-package-template <https://github.com/craigahobbs/python-package-template#readme>`__ as follows::
    ...
    template-specialize python-package-template/template/ package-name/ -k package package-name -k name 'John Doe' -k email 'johndoe@gmail.com' -k github 'johndoe' -k nomain 1
